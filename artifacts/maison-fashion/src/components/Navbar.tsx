...
export function Navbar() {
  return (
    <header className="fixed top-0 left-0 right-0 z-50 p-6 flex justify-between items-center mix-blend-difference text-white">
      <div className="font-serif tracking-[0.2em] text-xl md:text-2xl uppercase">FEMI'S HOUSE</div>
      <nav className="hidden md:flex gap-10 font-sans text-xs tracking-[0.2em] uppercase">
        <Link href="/" className="hover:opacity-70 transition-opacity">Collection</Link>
        <Link href="/atelier" className="hover:opacity-70 transition-opacity">Atelier</Link>
